                        ...
                        <Card className='d-flex align-items-center border-0 h-100'>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text className='text-left'>
                                    1st rank to NIST among all Engineering Colleges in EASTERN INDIA by DATAQUEST 2017 & 60th rank to NIST among the top engineering colleges of India by Outlook India 2019
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </div>
                    <div className='col-lg-4'>
                        <Card className='d-flex align-items-center border-0 h-100'>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text className='text-left'>
                                We prioritize student satisfaction, fostering a supportive environment where learning flourishes and well-being thrives, ensuring our students' happiness remains at the core of our educational mission.                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </div>
                    <div className='col-lg-4'>
                        <Card className='d-flex align-items-center border-0 h-100'>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text className='text-left'>
                                Our campus is nestled in a serene and tranquil location, offering students an idyllic environment conducive to focused learning, personal growth, and peaceful contemplation.                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </div>
                </div>
